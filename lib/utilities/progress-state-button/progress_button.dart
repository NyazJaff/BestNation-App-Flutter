...
class ProgressButton extends StatefulWidget {
  ...
  'Must be non-null widgetds provided in map of stateWidgets. Missing keys => ${ButtonState.values.toSet().difference(stateWidgets.keys.toSet())}',
        ...
        super(key: key) {
          Get.put(FlatDownloadController(tag), tag: tag);
        }
...
class _ProgressButtonState extends State<ProgressButton>
  ...
  get flatDownloadController => Get.find<FlatDownloadController>(tag: widget.tag);
        ...
        children: <Widget>[
          SizedBox(
            child: Obx(() => CircularPercentIndicator(
              ...
              // lineWidth: 5.0,
              percent: flatDownloadController.percent.value,
              center: IconButton(
